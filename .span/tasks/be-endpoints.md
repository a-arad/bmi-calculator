# span Task: Implement BMI Calculation Endpoints (ID: be-endpoints)

## Task Description
Create API endpoints for BMI calculation with both unit systems
...
DELIVERABLES: routes/bmi.js,utils/calculations.js
```
